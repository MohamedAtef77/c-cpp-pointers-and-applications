...
namespace Basic
{
    ...
    public:
        ...
        GArray(const GArray &other)
        {
            ...
            m_pBuffer = new T[static_cast<size_type>(other.m_size)];
        ...
        GArray& operator=(const GArray &other)
        {
            ...
            T *newBuffer = new T[static_cast<size_type>(other.m_size)];
            Copy(other.m_pBuffer, other.m_pBuffer + other.m_size, newBuffer);
